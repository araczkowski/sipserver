...
public class JsHeaderIntData extends JsHeaderData {
    ...
    public void copy(JsHeaderData src) {
        super.copy(src);
        if (src instanceof org.joinsip.core.JsHeaderIntData) {
            this.intValue = ((org.joinsip.core.JsHeaderIntData) src).getIntValue();
        }
    }

    public Object clone() {
        org.joinsip.core.JsHeaderIntData newObj = new org.joinsip.core.JsHeaderIntData(this.headerType);
        newObj.copy(this);
        return newObj;
    }
