...
public class JsHeaderData {
    ...
    public void copy(org.joinsip.core.JsHeaderData src) {
        copy(src, true);
    }

    public void copy(org.joinsip.core.JsHeaderData src, boolean headerTypeFlag) {
        if (headerTypeFlag) {
    ...
    public Object clone() {
        org.joinsip.core.JsHeaderData newObj = new org.joinsip.core.JsHeaderData(this.headerType);
        newObj.copy(this);
        return newObj;
    }
