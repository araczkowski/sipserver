...
public class JsSdpData {
  ...
  private String host;
  private org.joinsip.core.body.MLine[] mlines;
  ...
  public JsSdpData() {
    ...
    this.mlines = new org.joinsip.core.body.MLine[3];
  }

  public Object clone() {
    org.joinsip.core.body.JsSdpData obj = new org.joinsip.core.body.JsSdpData();
    obj.copy(this);
    return obj;
  }

  public void copy(org.joinsip.core.body.JsSdpData src) {
    ...
    for (int index = 0; index < this.mlines.length; index++) {
      ...
      if (mline == null) {
        ...
        this.mlines[index] = new org.joinsip.core.body.MLine(index, mline.getPort(), 1, JsSdpMediaInfo.TRANSPORT_RTP_AVP);
        this.mlines[index].copy((org.joinsip.core.body.MLine) mline);
      }
    }
  }
  ...
  public JsRTPInfo[] getSupportMediaInfoList(int media) {
    org.joinsip.core.body.MLine mline = this.mlines[media];
    if (mline == null) {
      return null;
    }
  ...
  public void parse(String body) {
    ...
    org.joinsip.core.body.MLine nowMLine = null;
      ...
      if (line.length() >= 2 && line.charAt(1) == '=') {
        switch (line.charAt(0)) {
          ...
          case 'c':
            ...
            break;
          case 'm':
            nowMLine = org.joinsip.core.body.MLine.parseMLine(line);
  ...
  private org.joinsip.core.body.MLine newMedia(int media, int port) {
    return new org.joinsip.core.body.MLine(media, port, 1, JsSdpMediaInfo.TRANSPORT_RTP_AVP);
  }
