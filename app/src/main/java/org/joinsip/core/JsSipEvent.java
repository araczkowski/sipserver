...
public class JsSipEvent extends JsTextBaseProtocolEvent {
    ...
    public org.joinsip.core.JsSipEvent createResponse(int statusCode) throws JsCoreException {
        if (isRequest()) {
            org.joinsip.core.JsSipEvent response = new org.joinsip.core.JsSipEvent(this);
    ...
    public org.joinsip.core.JsSipEvent createProxyRequestEvent(JsAddress proxyUri) throws JsCoreException {
        JsAddress newRequestUri;
        org.joinsip.core.JsSipEvent newEvent = new org.joinsip.core.JsSipEvent(this);
    ...
    public org.joinsip.core.JsSipEvent createProxyResponseEvent() throws JsCoreException {
        org.joinsip.core.JsSipEvent newEvent = new org.joinsip.core.JsSipEvent(this);
