...
public class JsHeaderAddressData extends JsHeaderData {
    ...
    public void copy(JsHeaderData src, boolean headerTypeFlag) {
        ...
        if (src instanceof org.joinsip.core.JsHeaderAddressData) {
            this.address = ((org.joinsip.core.JsHeaderAddressData) src).getAddress();
        }
    }
    ...
    public Object clone() {
        org.joinsip.core.JsHeaderAddressData newObj = new org.joinsip.core.JsHeaderAddressData(this.headerType);
        newObj.copy(this);
        return newObj;
    }
