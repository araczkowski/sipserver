...
public class JsHeaderViaData extends JsHeaderData {
    ...
    public void copy(JsHeaderData src) {
        super.copy(src);
        if (src instanceof org.joinsip.core.JsHeaderViaData) {
            org.joinsip.core.JsHeaderViaData srcVia = (org.joinsip.core.JsHeaderViaData) src;
    ...
    public Object clone() {
        org.joinsip.core.JsHeaderViaData newObj = new org.joinsip.core.JsHeaderViaData();
        newObj.copy(this);
        return newObj;
    }
