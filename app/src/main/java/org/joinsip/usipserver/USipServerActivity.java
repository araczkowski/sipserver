...
public class USipServerActivity extends Activity implements JsConsole {
    ...
    private final BroadcastReceiver receiver = new BroadcastReceiver() {
        public void onReceive(Context context, Intent intent) {
            if (intent.getAction().equals(org.joinsip.usipserver.USipServerActivity.INTENT_ACTION)) {
                org.joinsip.usipserver.USipServerActivity.this.out(intent.getStringExtra(org.joinsip.usipserver.USipServerActivity.INTENT_KEY));
            }
        }
    };
    ...
    public void startAction(View v) {
        org.joinsip.usipserver.USipServerActivity.this.startUSipServerService();
        checkboxSipLog.setChecked(false);
        checkboxRegisterLog.setChecked(false);
    }

    public void configer(View v) {
        org.joinsip.usipserver.USipServerActivity.this.startActivity(new Intent(org.joinsip.usipserver.USipServerActivity.this, ConfigActivity.class));
    }

    public void stop(View v) {
        org.joinsip.usipserver.USipServerActivity.this.stopService(new Intent(org.joinsip.usipserver.USipServerActivity.this.getBaseContext(), USipServerService.class));
    }
    ...
    public void status(View v) {
        ...
        org.joinsip.usipserver.USipServerActivity.this.sendBroadcast(intent);
    }
    ...
    public void clear(View v) {
        org.joinsip.usipserver.USipServerActivity.this.clearConsole();
    }
    ...
    public void clearConsole() {
        ...
        this.handler.post(new Runnable() {
            public void run() {
                org.joinsip.usipserver.USipServerActivity.this.console.setText(org.joinsip.usipserver.USipServerActivity.this.consoleText);
            }
        });
    }
