...
public class JsSimpleRegisterInfo {
    ...
    public static org.joinsip.impl.proxy.JsSimpleRegisterInfo parseLine(String line) {
        Log.e("ppt", line);
        ...
        if (lines.length == 3) {
            try {
                ...
                org.joinsip.impl.proxy.JsSimpleRegisterInfo newInfo = new org.joinsip.impl.proxy.JsSimpleRegisterInfo(tmpToUri, tmpContactUri);
